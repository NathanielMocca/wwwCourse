<%@ Page Language="C#" AutoEventWireup="true" CodeFile="youtubeOrder.aspx.cs" Inherits="_03_ASP_02_youtubeSimple_Default" %>
...
<body class="body">
    ...
    <div>
        ...
        <br />
        <br />
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/03_ASP/02_youtubeSimple/youtubeTrip.aspx">回前頁</asp:HyperLink>
        <br />
