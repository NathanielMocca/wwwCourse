<%@ Page Language="C#" AutoEventWireup="true" CodeFile="youtubeTrip.aspx.cs" Inherits="_03_ASP_01_simpleTrip_simpleTrip" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadioButtonList ID="placeRadioButtonList" runat="server" CssClass="formViewContent" RepeatDirection="Horizontal" Width="236px">
                            <asp:ListItem Value="1i1bZvbN0FQ" Selected="True">東京</asp:ListItem>
                            <asp:ListItem Value="WHVPk1oS4ME">紐約</asp:ListItem>
                            <asp:ListItem Value="TZM3bMkHrI0">倫敦</asp:ListItem>
                            <asp:ListItem Value="VVI5OvldHkA">埃及</asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
