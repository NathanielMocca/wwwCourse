<%@ Page Language="C#" AutoEventWireup="true" CodeFile="imageOrder.aspx.cs" Inherits="_03_ASP_04_image_imageOrder" %>
...
<body>
    ...
    <p>
        &nbsp; </p>
        <p>
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/03_ASP/04_image/imageTrip.aspx">回上頁</asp:HyperLink>
        </p>
        <p>
