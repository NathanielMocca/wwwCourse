...
public partial class _04_Database_store_trip : System.Web.UI.Page
{
    ...
    protected void goButton_Click(object sender, EventArgs e)
    {
        ...
        HiddenField youtubeHiddenField = (HiddenField)placeFormView.FindControl("youtubeHiddenField");
        ...
        Response.Redirect("order.aspx"); //重新導向網頁
    }
