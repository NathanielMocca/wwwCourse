...
public partial class _06_AJAX_store_AJAXtrip : System.Web.UI.Page
{
    ...
    protected void placeFormView_DataBound(object sender, EventArgs e)
    {
        ...
        HiddenField priceHiddenFieId = (HiddenField)placeFormView.FindControl("priceHiddenField");
        Label priceLabel = (Label)placeFormView.FindControl("priceLabel");
        priceLabel.Text = string.Format("{0:N0}", Convert.ToInt32(priceHiddenFieId.Value));
        totalHiddenField.Value = (Convert.ToInt32(priceHiddenFieId.Value) * Convert.ToInt32(daysTextBox.Text)).ToString();
    ...
    protected void goButton_Click(object sender, EventArgs e)
    {
        ...
        HiddenField youtubeIdHiddenField = (HiddenField)placeFormView.FindControl("youtubeHiddenField");
