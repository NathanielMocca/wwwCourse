<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vote.aspx.cs" Inherits="_06_AJAX_vote_vote" %>
    ...
    <div>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:RadioButtonList ID="RadioButtonList2" runat="server" DataSourceID="SqlDataSource4" DataTextField="season" DataValueField="seasonId" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList2_SelectedIndexChanged">
                    </asp:RadioButtonList>
