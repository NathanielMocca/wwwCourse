<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ajaxLocation.aspx.cs" Inherits="_07_WebServices_aspLocation" %>
...
<body class="body">
    ...
    <div class="body">
        <div>
            <span class="title">ASP.Net UpdatePanel AJAX網頁<br />
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <br />
                                        latitude:
                                        <asp:TextBox ID="latitudeTextBox0" runat="server" Text='<%# Bind("latitude") %>' />
                    <br />
                                        longitude:
                                        <asp:TextBox ID="longitudeTextBox0" runat="server" Text='<%# Bind("longitude") %>' />
                    <br />
